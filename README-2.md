...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_analytics_vm"></a> [analytics\_vm](#module\_analytics\_vm) | git::https://github.com/vegorshkov/yandex_compute_instance.git | n/a |
| <a name="module_marketing_vm"></a> [marketing\_vm](#module\_marketing\_vm) | git::https://github.com/vegorshkov/yandex_compute_instance.git | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_analytics_vm"></a> [analytics\_vm](#output\_analytics\_vm) | n/a |
| <a name="output_marketing_vm"></a> [marketing\_vm](#output\_marketing\_vm) | n/a |
